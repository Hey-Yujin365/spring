 ...
 * 			* final 키워드가 지정되어 있는 멤버변수를 초기화하는 방법은 2가지 있다.
 * 				- 멤버변수에 직접 값을 대입하기
...
public class UserService {
	 ...
	 * 			5. 신규 회원정보가 저장된 User객체를 mybatis에 전달해서 데이터베이스에 저장시킨다.
	 * 			6. 신규 회원은 ROLE_USER 권한을 부여하기 위해서 UserRole 객체를 생성해서 사용자 번호와 "ROLE_USER"객체를 대입한다.
	...
	public void registerUser(UserRegisterForm form) {
		...
		// form에 있는 정보로 no를 제외한 정보가 들어있는 User객체 획득
